...
public class ServeurSite implements Runnable {
    ...
    public String page() {
        ...
        h.append("<h2>Votre commande</h2>")
                ...
                .append("<button class='envoyer' onclick='validerCommande()'>Envoyer ma commande</button>")
                ...
                .append("function validerCommande(){var l=[];for(var k in panier)l.push({id:k,nom:panier[k].nom,pv:panier[k].pv,q:panier[k].q});")
