...
(function () {
  ...
  function avaHtml(u, cls) {
    cls = cls || 'ava-m';
    if (u && u.avatar) return '<div class="ava ' + cls + '"><img src="' + u.avatar + '" alt=""></div>';
    if (u && u.logo) return '<div class="ava ' + cls + '" style="border-radius:12px"><img src="' + u.logo + '" alt=""></div>';
  ...
  function posterHtml(p) {
    ...
    var photos = (p.photos || []).map(function (u) {
      return '<img src="' + u + '" loading="lazy" alt="">';
    }).join('');
  ...
  function offreHtml(o) {
    ...
    var img = o.photo ? '<img class="offre-img" src="' + o.photo + '" alt="">' : '';
    var pl = o.partenaire || {};
    return '<div class="offre">' + img +
      '<div class="offre-corps">' +
      '<div class="offre-p">' +
      (pl.logo ? '<img src="' + pl.logo + '" alt="">' : (pl.avatar ? '<img src="' + pl.avatar + '" alt="">' : '')) +
  ...
  function composerAva() {
    var z = $('compo-ava');
    if (moi && moi.avatar) { z.innerHTML = '<img src="' + moi.avatar + '" alt="">'; z.style.display = ''; }
  ...
  function envoiHtml(e, peutRepondre) {
    ...
    return '<div class="envoi ' + st + '">' +
      '<div class="tete">' +
      (e.autre && (e.autre.logo || e.autre.avatar) ? '<img src="' + (e.autre.logo || e.autre.avatar) + '" alt="">' : '') +
  ...
  function ouvrirProfil() {
    ...
    c.innerHTML =
      ...
      (moi.avatar ? '<div class="ava ava-l"><img src="' + moi.avatar + '" alt=""></div>' :
      ...
      (moi.logo ? '<img src="' + moi.logo + '" style="width:64px;height:64px;object-fit:contain;border:1px solid var(--trait);border-radius:10px">' : '') +
