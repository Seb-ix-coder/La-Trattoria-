...
| `carte/` | **Gestion de la carte** (PWA autonome et hors ligne) : produits, photos, marges, cartes du jour, **ardoise de la carte principale éditable** (titres/sous-titres par catégorie, lignes libres, photos, QR du site, design craie sur ardoise), synchro tablettes, page publique clients responsive avec logo et visuel Petit Futé 2026 |
